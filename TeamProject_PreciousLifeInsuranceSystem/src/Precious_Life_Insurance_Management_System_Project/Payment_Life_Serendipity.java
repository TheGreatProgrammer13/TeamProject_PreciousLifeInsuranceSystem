...
public class Payment_Life_Serendipity extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Payment_Life_Serendipity frame = new Payment_Life_Serendipity();
	 ...
	 * Create the frame.
	 */
	public Payment_Life_Serendipity() {
