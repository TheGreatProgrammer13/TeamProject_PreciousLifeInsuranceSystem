...
public class Payment_Health_Elderly_Care extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Payment_Health_Elderly_Care() {
		...
		panel_1_1_2.setBounds(200, 130, 713, 208);
		...
		JLabel Serene = new JLabel("Elderly-Care");
