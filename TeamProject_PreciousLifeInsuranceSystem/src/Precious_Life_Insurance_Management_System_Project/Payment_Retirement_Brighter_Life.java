...
public class Payment_Retirement_Brighter_Life extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Payment_Retirement_Brighter_Life() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (RBalance ==0) {
					...
					JOptionPane.showMessageDialog(null, 
							...
							+ "\nType of Insurance: Retirement Insurance \nPlan: Brighter Life" 
							+ "\nStatus: PAID"
