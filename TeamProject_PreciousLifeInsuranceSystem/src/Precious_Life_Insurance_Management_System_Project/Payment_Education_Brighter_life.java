...
public class Payment_Education_Brighter_life extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Payment_Education_Brighter_life() {
		...
		JLabel LifeInsurance = new JLabel("Education");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (RBalance ==0) {
					...
					JOptionPane.showMessageDialog(null, 
							...
							+ "\nType of Insurance: Education Insurance \nPlan: Bright Life" 
							+ "\nStatus: PAID"
