...
public class Payment_Investment_Dollar_Bundle extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Payment_Investment_Dollar_Bundle() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (RBalance ==0) {
					...
					JOptionPane.showMessageDialog(null, 
							...
							+ "\nType of Insurance: Investment Insurance \nPlan: Dollar Bundle" 
							+ "\nStatus: PAID"
